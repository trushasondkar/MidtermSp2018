...
This is an R Markdown document and your exam. Markdown is a simple formatting syntax for authoring HTML, PDF, and MS Word documents. 
...
```{r, echo = FALSE}
print("I haven't answered and so this comment is here = Where is my plot?")
